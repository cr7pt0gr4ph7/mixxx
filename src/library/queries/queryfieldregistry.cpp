...
QList<QueryFieldInfo> QueryFieldRegistry::s_defaultFields = {
 ...
 : m_name(name), m_localizedName(localizedName), m_fields(fields){
 }

    QueryFieldRegistry::QueryFieldRegistry(): m_defaultFieldsAdded(false) {}

    QueryFieldRegistry::QueryFieldRegistry(const QList<QString>& fields) : m_defaultFieldsAdded(false) {
        addFields(fields);
    }

    const QueryFieldInfo QueryFieldRegistry::get(const QString& name) const {
    ...
    const QList<QString> QueryFieldRegistry::allFields() const {
        return m_allFields;
    }

    const QList<QueryFieldCategory> QueryFieldRegistry::allFieldsByCategory() const {
