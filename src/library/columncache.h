...
class ColumnCache : public QObject {
  ...
  public:
    enum Column {
        ...
        COLUMN_LIBRARYTABLE_CUSTOM_METADATA_JSON,
        ...
        COLUMN_CUSTOMFIELDS_FIELD_1,
        COLUMN_CUSTOMFIELDS_FIELD_2,
        COLUMN_CUSTOMFIELDS_FIELD_3,
        COLUMN_CUSTOMFIELDS_FIELD_4,
        COLUMN_CUSTOMFIELDS_FIELD_5,
        COLUMN_CUSTOMFIELDS_FIELD_6,
        COLUMN_CUSTOMFIELDS_FIELD_7,
        COLUMN_CUSTOMFIELDS_FIELD_8,
        COLUMN_CUSTOMFIELDS_FIELD_9,
        COLUMN_CUSTOMFIELDS_FIELD_10,
        COLUMN_CUSTOMFIELDS_FIELD_11,
        COLUMN_CUSTOMFIELDS_FIELD_12,
        COLUMN_CUSTOMFIELDS_FIELD_13,
        COLUMN_CUSTOMFIELDS_FIELD_14,
        COLUMN_CUSTOMFIELDS_FIELD_15,
        COLUMN_CUSTOMFIELDS_FIELD_16,
        COLUMN_CUSTOMFIELDS_FIELD_17,
        COLUMN_CUSTOMFIELDS_FIELD_18,
        COLUMN_CUSTOMFIELDS_FIELD_19,
        COLUMN_CUSTOMFIELDS_FIELD_20,
        COLUMN_CUSTOMFIELDS_MAX_FIELD = COLUMN_CUSTOMFIELDS_FIELD_20,
